...
var xpathPattern = {
  ...
  isValidPattern: function (pattern) {
    ...
    while (openPosition > - 1) {
      ...
      nextClosePosition = pattern.indexOf(CLOSE_ANGLE_BRACKET, closePosition);

      if (closePosition < nextOpenPosition || closePosition <= -1 || nextOpenPosition < nextClosePosition) {
        return false;
      }
